...
export const projects: Project[] = [
  {
    ...
    cover: '/02_Projects/01_Winona/01_Winona_Portada.png',
    ...
    media: [
      { type: 'image', src: '/02_Projects/01_Winona/02_Winona.png', alt: 'Winona digital experience', ratio: 'wide' },
      ...
      { type: 'image', src: '/02_Projects/01_Winona/03_Winona.png', alt: 'Winona campaign composition', ratio: 'portrait' },
      { type: 'image', src: '/02_Projects/01_Winona/04_Winona.png', alt: 'Winona brand details', ratio: 'portrait' },
      ...
      { type: 'image', src: '/02_Projects/01_Winona/09_Winona.png', alt: 'Winona final composition', ratio: 'wide' },
    ],
  },
  {
    slug: 'genova', number: '02', title: 'Genova', year: '2025',
    role: 'Art Direction + Visual Design', accent: '#b7d5ff', comingSoon: true,
    cover: '/02_Projects/02_Genova/01_Genova_Portada.png',
  ...
  },
  {
    ...
    cover: '/02_Projects/04_MaxMaher/01_MaxMaher_Portada.png',
    ...
    media: [
      { type: 'image', src: '/02_Projects/04_MaxMaher/01_MaxMaher.png', alt: 'Max Maher visual system', ratio: 'wide' },
      ...
      { type: 'image', src: '/02_Projects/04_MaxMaher/04_MaxMaher.png', alt: 'Max Maher graphic detail', ratio: 'portrait' },
      { type: 'image', src: '/02_Projects/04_MaxMaher/10_MaxMaher.png', alt: 'Max Maher campaign', ratio: 'wide' },
    ],
  },
  {
    slug: 'outliant', number: '05', title: 'Outliant', year: '2024',
    role: 'Art Director, Brand Strategist & UX/UI Design Lead', accent: '#ddff55',
    cover: '/02_Projects/05_Outliant/01_Outliant_Portada.png',
    ...
    media: [
      { type: 'image', src: '/02_Projects/05_Outliant/01_OTL.png', alt: 'Outliant brand system', ratio: 'portrait' },
      ...
      { type: 'image', src: '/02_Projects/05_Outliant/07__OTL.png', alt: 'Outliant web experience', ratio: 'wide' },
    ],
  },
  {
    slug: 'lumen', number: '06', title: 'Lumen', year: '2022',
    role: 'Art Direction + Visual Design', accent: '#f6a66d',
    cover: '/02_Projects/06_Lumen/01_Lumen_Portada.png',
    ...
    media: [
      { type: 'image', src: '/02_Projects/06_Lumen/02_Lumen.png', alt: 'Lumen experience overview', ratio: 'wide' },
      { type: 'video', vimeoId: '1215371918', alt: 'Lumen interactive motion' },
      { type: 'image', src: '/02_Projects/06_Lumen/06_Lumen.png', alt: 'Lumen visual detail', ratio: 'portrait' },
      { type: 'image', src: '/02_Projects/06_Lumen/17_Lumen.png', alt: 'Lumen final experience', ratio: 'wide' },
    ],
  },
  {
    slug: 'blend360', number: '07', title: 'Blend360', year: '2024',
    role: 'UX—UI Lead, Visual & Motion Designer', accent: '#d8c5ff', comingSoon: true,
    cover: '/02_Projects/07_Blend360/01_Blend360_Portada.png',
